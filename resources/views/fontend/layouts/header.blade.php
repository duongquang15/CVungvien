			...
			<div class="logo-header" data-background-color="white">
				...
				<button class="topbar-toggler more" style="color: black"><i class="icon-options-vertical" style="color: black"></i></button>
			...
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="blue">
				...
				<div class="container-fluid">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						{{-- <li style="margin-right: 2500px; width: 1000px">
							<div class="scroll-left">
								<h4 style="color: yellow;"> Giải đấu đua xe     <i class="fa fa-bicycle" aria-hidden="true"></i>    <i class="fa fa-bicycle" aria-hidden="true"></i>       <i class="fa fa-bicycle" aria-hidden="true"></i>           <i class="fa fa-bicycle" aria-hidden="true"></i> Đặt cược ngay, Đặt cược ngay trúng liên tay . Hotline 19008198 </h4>
								</div>
						</li> --}}
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<i class="fas fa-user " style=" color: white; font-size: 20px; margin-top: 10px"></i>
								</div>
							</a>
